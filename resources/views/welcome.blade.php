					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<img alt="Logo" src="backend/media/logos/logo2.png" class="h-60px logo" />
											...
											<!--end::Description-->
											<!--begin::Action-->
											<a href="{{route('register')}}" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">Welcome</a>
											<!--end::Action-->
										</div>
										<!--end::Heading-->
										<!--begin::Illustration-->
										<div class="text-center px-5">
											<img src="backend/media/illustrations/sketchy-1/2.png" alt="" class="mw-100 h-200px h-sm-325px" />
										</div>
										<!--end::Illustration-->
									</div>
									<!--end::Card body-->
